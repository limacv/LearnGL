...
{
    objectShader = Shader("./src/LearnOpenGL/shader/modelShader.vert", 
                        "./src/LearnOpenGL/shader/modelShader.frag", 
                        "./src/LearnOpenGL/shader/geom.geom");
    // import model
...
{
    // -----------------------------------
    objectShader.setUniform("time", (float)glfwGetTime());
    //// view Matrix
